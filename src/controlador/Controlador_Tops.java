...
public class Controlador_Tops {
	...
	public void iniciarControlador(){
		...
		try {
			...
			DefaultTableModel model = VentanaTop.getModelMunicipios();
			model.setRowCount(0);
			...
			DefaultTableModel modelBizka = VentanaTop.getModelBizkaia();
			...
			DefaultTableModel modelAraba = VentanaTop.getModelAraba();
			...
			DefaultTableModel modelGipu = VentanaTop.getModelGuipu();
			...
			DefaultTableModel modelEtornos = VentanaTop.getModelEspacios();
